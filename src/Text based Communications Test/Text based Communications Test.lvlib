...
<Library LVVersion="17008000">
	...
	<Item Name="Messages for this Actor" Type="Folder">
		<Item Name="Validate Response Msg.lvclass" Type="LVClass" URL="../../Text based Communications Test Messages/Validate Response Msg/Validate Response Msg.lvclass"/>
	</Item>
	<Item Name="File based Comm Helper Loop States.ctl" Type="VI" URL="../File based Comm Helper Loop States.ctl"/>
	<Item Name="File Data Format.ctl" Type="VI" URL="../File Data Format.ctl"/>
	<Item Name="Text based Communications Test.lvclass" Type="LVClass" URL="../Text based Communications Test.lvclass"/>
</Library>
